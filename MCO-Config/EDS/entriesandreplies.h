...
#define OD_1000H_LIST \
  0x00000000L, /* [0x1000,0x00] Device Type (Unsigned32) */ \
...
/* [0x0001,0x00] BOOLEAN (Boolean) */ \
SDOREPLY(0x0001, 0x00, 0, 0x00000000L), \
/* [0x0002,0x00] INTEGER8 (Integer8) */ \
SDOREPLY(0x0002, 0x00, 1, 0x00000000L), \
/* [0x0003,0x00] INTEGER16 (Integer16) */ \
SDOREPLY(0x0003, 0x00, 2, 0x00000000L), \
/* [0x0004,0x00] INTEGER32 (Integer32) */ \
SDOREPLY(0x0004, 0x00, 4, 0x00000000L), \
/* [0x0005,0x00] UNSIGNED8 (Unsigned8) */ \
SDOREPLY(0x0005, 0x00, 1, 0x00000000L), \
/* [0x0006,0x00] UNSIGNED16 (Unsigned16) */ \
SDOREPLY(0x0006, 0x00, 2, 0x00000000L), \
/* [0x0007,0x00] UNSIGNED32 (Unsigned32) */ \
SDOREPLY(0x0007, 0x00, 4, 0x00000000L), \
...
SDOREPLY(0x1016, 0x00, 1, 0x0000000AL), \
...
SDOREPLY(0x1800, 0x05, 2, 0x000001F4L), \
...
SDOREPLY(0x1801, 0x03, 2, 0x000009C4L), \
...
ODENTRY(0x6000, 0x01, 1+ODRD+RMAP, P600001_VC_Command), \
ODENTRY(0x6000, 0x02, 1+ODRD+RMAP, P600002_VC_Accuracy), \
...
ODENTRY(0x1000, 0x00, 4+ODRD, P100000_Device_Type), \
ODENTRY(0x1001, 0x00, 1+ODRD, P100100_Error_Register), \
ODENTRY(0x1005, 0x00, 4+ODRD, P100500_COB_ID_SYNC), \
ODENTRY(0x1006, 0x00, 4+ODRD+ODWR, P100600_SYNC_Communication_cycle_time), \
...
ODENTRY(0x1014, 0x00, 4+ODRD, P101400_COB_ID_EMCY), \
ODENTRY(0x1016, 0x01, 4+ODRD+ODWR, P101601_Consumer_HB_Time), \
ODENTRY(0x1016, 0x02, 4+ODRD+ODWR, P101602_Consumer_HB_Time), \
ODENTRY(0x1016, 0x03, 4+ODRD+ODWR, P101603_Consumer_HB_Time), \
ODENTRY(0x1016, 0x04, 4+ODRD+ODWR, P101604_Consumer_HB_Time), \
ODENTRY(0x1016, 0x05, 4+ODRD+ODWR, P101605_Consumer_HB_Time), \
ODENTRY(0x1016, 0x06, 4+ODRD+ODWR, P101606_Consumer_HB_Time), \
ODENTRY(0x1016, 0x07, 4+ODRD+ODWR, P101607_Consumer_HB_Time), \
ODENTRY(0x1016, 0x08, 4+ODRD+ODWR, P101608_Consumer_HB_Time), \
ODENTRY(0x1016, 0x09, 4+ODRD+ODWR, P101609_Consumer_HB_Time), \
ODENTRY(0x1016, 0x0A, 4+ODRD+ODWR, P10160A_Consumer_HB_Time), \
ODENTRY(0x1017, 0x00, 2+ODRD+ODWR, P101700_Producer_Heartbeat_Time), \
ODENTRY(0x1019, 0x00, 1+ODRD+ODWR, P101900_SYNC_counter_overflow_value), \
ODENTRY(0x1400, 0x00, 1+ODRD, P140000_Highest_Subindex), \
ODENTRY(0x1400, 0x01, 4+ODRD+ODWR, P140001_COB_ID), \
ODENTRY(0x1400, 0x02, 1+ODRD+ODWR, P140002_Transmission_Type), \
ODENTRY(0x1401, 0x00, 1+ODRD, P140100_Highest_Subindex), \
ODENTRY(0x1401, 0x01, 4+ODRD+ODWR, P140101_COB_ID), \
ODENTRY(0x1401, 0x02, 1+ODRD+ODWR, P140102_Transmission_Type), \
ODENTRY(0x1800, 0x01, 4+ODRD+ODWR, P180001_COB_ID), \
...
ODENTRY(0x1800, 0x06, 1+ODRD+ODWR, P180006_Sync_Start_Value), \
ODENTRY(0x1801, 0x01, 4+ODRD+ODWR, P180101_COB_ID), \
...
ODENTRY(0x1801, 0x06, 1+ODRD+ODWR, P180106_Sync_Start_Value), \
...
#define OD_ID_LIST \
  ...
  0x600001, /* [0x6000,0x01] Read State 8 Input Lines - VC_Command (Unsigned8) */ \
  0x600002, /* [0x6000,0x02] Read State 8 Input Lines - VC_Accuracy (Unsigned8) */ \
...
#define OD_ID_TYPE \
  ...
  TYPE_UNSIGNED8      , /* [0x6000,0x01] Read State 8 Input Lines - VC_Command (Unsigned8) */ \
  TYPE_UNSIGNED8      , /* [0x6000,0x02] Read State 8 Input Lines - VC_Accuracy (Unsigned8) */ \
...
#define OD_ID_TABLELOCATION \
  ODLOC_SDOREPLY, /* [0x0001,0x00] BOOLEAN (Boolean) */ \
  ODLOC_SDOREPLY, /* [0x0002,0x00] INTEGER8 (Integer8) */ \
  ODLOC_SDOREPLY, /* [0x0003,0x00] INTEGER16 (Integer16) */ \
  ODLOC_SDOREPLY, /* [0x0004,0x00] INTEGER32 (Integer32) */ \
  ODLOC_SDOREPLY, /* [0x0005,0x00] UNSIGNED8 (Unsigned8) */ \
  ODLOC_SDOREPLY, /* [0x0006,0x00] UNSIGNED16 (Unsigned16) */ \
  ODLOC_SDOREPLY, /* [0x0007,0x00] UNSIGNED32 (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1000,0x00] Device Type (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1001,0x00] Error Register (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1005,0x00] COB-ID SYNC (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1006,0x00] SYNC Communication cycle time (Unsigned32) */ \
  ...
  ODLOC_ODENTRY , /* [0x1014,0x00] COB-ID EMCY (Unsigned32) */ \
  ...
  ODLOC_ODENTRY , /* [0x1016,0x01] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x02] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x03] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x04] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x05] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x06] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x07] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x08] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x09] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1016,0x0A] Consumer Heartbeat Time - Consumer HB Time (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1017,0x00] Producer Heartbeat Time (Unsigned16) */ \
  ...
  ODLOC_ODENTRY , /* [0x1019,0x00] SYNC counter overflow value (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1400,0x00] Receive PDO Communication Parameter - Highest Subindex (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1400,0x01] Receive PDO Communication Parameter - COB-ID (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1400,0x02] Receive PDO Communication Parameter - Transmission Type (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1401,0x00] Receive PDO Communication Parameter - Highest Subindex (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1401,0x01] Receive PDO Communication Parameter - COB-ID (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1401,0x02] Receive PDO Communication Parameter - Transmission Type (Unsigned8) */ \
  ...
  ODLOC_ODENTRY , /* [0x1800,0x01] Transmit PDO Communication Parameter - COB-ID (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1800,0x02] Transmit PDO Communication Parameter - Transmission Type (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1800,0x03] Transmit PDO Communication Parameter - Inhibit Time (Unsigned16) */ \
  ODLOC_ODENTRY , /* [0x1800,0x05] Transmit PDO Communication Parameter - Event Timer (Unsigned16) */ \
  ODLOC_ODENTRY , /* [0x1800,0x06] Transmit PDO Communication Parameter - Sync Start Value (Unsigned8) */ \
  ODLOC_SDOREPLY, /* [0x1801,0x00] Transmit PDO Communication Parameter - Highest Subindex (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1801,0x01] Transmit PDO Communication Parameter - COB-ID (Unsigned32) */ \
  ODLOC_ODENTRY , /* [0x1801,0x02] Transmit PDO Communication Parameter - Transmission Type (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x1801,0x03] Transmit PDO Communication Parameter - Inhibit Time (Unsigned16) */ \
  ODLOC_ODENTRY , /* [0x1801,0x05] Transmit PDO Communication Parameter - Event Timer (Unsigned16) */ \
  ODLOC_ODENTRY , /* [0x1801,0x06] Transmit PDO Communication Parameter - Sync Start Value (Unsigned8) */ \
  ...
  ODLOC_ODENTRY , /* [0x6000,0x01] Read State 8 Input Lines - VC_Command (Unsigned8) */ \
  ODLOC_ODENTRY , /* [0x6000,0x02] Read State 8 Input Lines - VC_Accuracy (Unsigned8) */ \
